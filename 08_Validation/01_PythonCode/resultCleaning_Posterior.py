...
def normalizeSimuPC6consumption(year):
    ...
    cur.execute(
        """
            ...
            sum(simu."Posterior_""" + str(year) + """_h_wh")/(1000*avg(PC6list."pc6_vsum")) as Posterior_""" + str(year) + """_kWh_m3
            ...
            (
                ...
                from "Posterior_""" + str(year) + """results" as tb1
...
def main():
    ...
    cwd = os.getcwd()
    savePath = cwd + '/../../10_Validation/PosteriorResult_' + str(year) +'.csv'
